...
namespace Bicep.Core.UnitTests.TypeSystem
{
    ...
    public class TypeValidatorAssignabilityTests
    {
        ...
        private TypeManager CreateTypeManager() => new TypeManager(TestResourceTypeProvider.Create(), new Dictionary<SyntaxBase, Symbol>(), new Dictionary<DeclaredSymbol, ImmutableArray<DeclaredSymbol>>());
    }
}